  ...
  <section class="page-404">
         <div class="container">
            ...
            <span class="pagenot-found">Our website is going under maintenance. We will be back very soon!.</span>
            <!-- <a class="gotohome" href="index.html">Go Back to home</a> -->
         </div>
      </section>
      <!--=========404 section end============-->
      <!--=========Footer Start============-->
         ...
         <div class="ftr-section">
            <div class="container">
               <ul class="footer-info">
                  ...
                  <li class="ftr-phn">08027064279</li>
