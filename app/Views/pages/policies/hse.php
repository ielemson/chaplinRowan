            ...
            <div class="row">
             ...
             <div class="col-md-8 right-column">
                  <div class="service-right-desc">
                     ...
                     <img src="/images/safety.jpg" class="img-responsive zoom_img_effect" alt="manufacture-image">
                     </span>
               ...
               <div class="col-md-4 left-column">
                  <ul class="category-list" class="active-category">
                  <li><a href="hse" class="active-category">Health Safety &amp; Environment</a></li>
                  ...
                  <div class="contact-help">
                     <div class="office-info-col wdt-100">
                        ...
                        <ul class="office-information">
                           <li class="office-loc">
                              < <span class="info-txt">Plot G81 Road 2, VGC, Lekki Epe Exp. Way, Lagos.</>
                           </li>
                           <li class="office-phn">
